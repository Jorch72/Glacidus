...
public class BlockGlacidusSlab extends BlockSlab 
{
	private String name;

	private boolean double_slab;

	public BlockGlacidusSlab(String name, boolean double_slab, Material materialIn) 
	{
		super(materialIn);
		this.name = name;
    ...
    {
    	if (this == BlocksGlacidus.underground_double_slab) { return BlocksGlacidus.underground_slab; }
    	else { return this; }
    }
