...
public class ModelGlacium implements IModel
{

	private ResourceLocation fluidStill, fluidFlowing;

	public ModelGlacium()
	{
		this.fluidStill = ModInfo.locate("blocks/glacium_still");
		this.fluidFlowing = ModInfo.locate("blocks/glacium_flow");
	}

    public Collection<ResourceLocation> getTextures()
    {
        return ImmutableSet.of(this.fluidStill, this.fluidFlowing);
    }
    ...
    public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter)
    {
        ...
        return new BakedFluid(state.apply(Optional.empty()), map, format, 0xFFFFFF, bakedTextureGetter.apply(this.fluidStill), bakedTextureGetter.apply(this.fluidFlowing), true, Optional.empty());
    }
    ...
    @Override
    public ModelGlacium process(ImmutableMap<String, String> customData)
    {
        return new ModelGlacium();
    }
}