package com.legacy.glacidus.client.renders.tiles;
...
public class GlacidusPortalRenderer extends TileEntitySpecialRenderer<TileEntityGlacidusPortal> 
{
	private static final ResourceLocation END_SKY_TEXTURE = ModInfo.locate("textures/environment/glacidus_sky.png");
    private static final ResourceLocation END_PORTAL_TEXTURE = ModInfo.locate("textures/entity/glacidus_portal.png");
    private static final Random RANDOM = new Random(31100L);
    private static final FloatBuffer MODELVIEW = GLAllocation.createDirectFloatBuffer(16);
    private static final FloatBuffer PROJECTION = GLAllocation.createDirectFloatBuffer(16);
    private final FloatBuffer buffer = GLAllocation.createDirectFloatBuffer(16);

    public void render(TileEntityGlacidusPortal te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            float f3 = (RANDOM.nextFloat() * 0.1F + 0.01F) * f1;
            float f4 = (RANDOM.nextFloat() * 0.4F + 0.4F) * f1;
            float f5 = (RANDOM.nextFloat() * 1.2F + 0.5F) * f1;
