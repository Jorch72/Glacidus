package com.legacy.glacidus.client.renders.world;
...
public class GlacidusSkyRenderer extends IRenderHandler
{
	...
	public GlacidusSkyRenderer()
	{
        ...
        this.vertexBufferFormat.addElement(DefaultVertexFormats.POSITION_3F);
        this.vertexBufferFormat.addElement(DefaultVertexFormats.COLOR_4UB);
        ...
        for (int i = 0; i < 2500; ++i)
        {
            ...
            if (d4 < 1.0D && d4 > 0.01D)
            {
                ...
                for (int j = 0; j < 4; ++j)
                {
                    ...
                    bufferBuilderIn.pos(d5 + d25, d6 + d23, d7 + d26).color(R, G, B, 0.8F).endVertex();
                }
            }
        }
    }
