...
public class MapGenGlacidusCaves extends MapGenBase
{

    protected static final IBlockState BLK_GLACIUM = BlocksGlacidus.glacium.getDefaultState();
    ...
    {
        if (p_175793_1_.getBlock() == BlocksGlacidus.frozen_antinatric_stone)
        {
            return true;
        }
        else if (p_175793_1_.getBlock() == BlocksGlacidus.lumicia_dirt)
        {
            return true;
        }
        else if (p_175793_1_.getBlock() == BlocksGlacidus.lumicia_grass)
        {
            return true;
        }
        else if (p_175793_1_.getBlock() == BlocksGlacidus.thawed_antinatric_stone)
        {
            return true;
        }
        else
        {
            return p_175793_2_.getMaterial() != GlacidusMaterial.GLACIUM;
        }
    }
    ...
    protected boolean isOceanBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ)
    {
        ...
        return block== BlocksGlacidus.glacium;
    }
    ...
    private boolean isTopBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ)
    {
        ...
        return (state.getBlock() == BlocksGlacidus.frozen_antinatric_stone);
    }
