...
public class MapGenGlacidusRavine extends MapGenBase
{

    protected static final IBlockState FLOWING_GLACIUM = BlocksGlacidus.glacium.getDefaultState();
    ...
    {
        IBlockState state = data.getBlockState(x, y, z);
        IBlockState top =  BlocksGlacidus.frozen_antinatric_stone.getDefaultState();
        IBlockState filler = BlocksGlacidus.frozen_antinatric_stone.getDefaultState();
