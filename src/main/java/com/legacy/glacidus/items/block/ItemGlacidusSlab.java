package com.legacy.glacidus.items.block;
...
public class ItemGlacidusSlab extends ItemBlock
{
    private final BlockSlab singleSlab;
    private final BlockSlab doubleSlab;

    public ItemGlacidusSlab(Block block, BlockSlab singleSlab, BlockSlab doubleSlab)
    {
        super(block);
